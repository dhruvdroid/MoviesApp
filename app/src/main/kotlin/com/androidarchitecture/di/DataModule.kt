...
import com.androidarchitecture.data.repository.RetrofitMovieRepository
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindUserRepository(repository: RetrofitMovieRepository): MovieRepository
}
